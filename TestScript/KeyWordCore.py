...
def execute_test_case():
    ...
    for testcase in test_cases[1:]:
        ...
        if "y" in testcase[is_test_executed_flag_col_no].lower():
            ...
            wb.write_a_line_in_sheet(test_steps_info[0], fgcolor="4169E1")

            for test_step in test_steps_info[1:]:

                flag = True
                test_step_description = test_step[test_step_description_col_no]
            ...
            if flag is True:
                ...
                wb.write_a_line_in_sheet(test_cases[0],fgcolor="4169E1")
